...
public sealed class MainViewModel : ObservableObject
{
    ...
    [
        ("textures", "Image Editors", "M 5.0,3.0 h 14.0 a 2.0,2.0 0 0 1 2.0,2.0 v 14.0 a 2.0,2.0 0 0 1 -2.0,2.0 h -14.0 a 2.0,2.0 0 0 1 -2.0,-2.0 v -14.0 a 2.0,2.0 0 0 1 2.0,-2.0 z M 7.0,9.0 a 2.0,2.0 0 1 0 4.0,0 a 2.0,2.0 0 1 0 -4.0,0 m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"),
        ...
        ("system", "Windows Explorer", "M 4.0,4.0 h 16.0 a 2.0,2.0 0 0 1 2.0,2.0 v 12.0 a 2.0,2.0 0 0 1 -2.0,2.0 h -16.0 a 2.0,2.0 0 0 1 -2.0,-2.0 v -12.0 a 2.0,2.0 0 0 1 2.0,-2.0 z M10 4v4 M2 8h20 M6 4v4"),
